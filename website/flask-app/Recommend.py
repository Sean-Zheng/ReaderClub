...
def recommend():
    ...
    for user_item_id in user_set:
        ...
        user_message=UserMessage(user_item,user_item_book_set,similarity_degree)
    ...
    sort_list=sorted(book_dict.items(),key=lambda item: item[1],reverse=True)
    result_list=[]
...
class UserMessage(object):
    ...
    def printMessage(self):
        print("{}-{}:{}".format(self.user_id,self.user_name,self.similarity_degree))
        pass