...
Bookshelf = db.Table('Bookshelves',
                     ...
                     db.Column('BookID', db.Integer, db.ForeignKey(
                         'BookMessages.BookID'), primary_key=True)
                     )
...
class Favourite(db.Model):
    ...
    TypeID = db.Column(db.Integer, db.ForeignKey(
        'BookTypes.TypeID'), primary_key=True)
    pass
...
class BookComment(db.Model):
    ...
    BookID = db.Column(db.Integer, db.ForeignKey(
        'BookMessages.BookID'), nullable=False)
...
class User(db.Model):
    ...
    books = db.relationship(
        'BookMessage', secondary=Bookshelf, backref=db.backref('users'))
    # 一对多关系定义
...
class BookMessage(db.Model):
    ...
    TypeID = db.Column(db.Integer, db.ForeignKey(
        'BookTypes.TypeID'), nullable=False)
